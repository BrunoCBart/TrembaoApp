...
describe('login route /users testing', () => {
    it('login returns token', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield chai.request(app_1.app)
            .post('/users/login')
            .send({
            username: 'admin',
            password: 'mysecretpw'
    ...
    it('Validate login returns token', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield chai.request(app_1.app)
            .get('/users/login')
